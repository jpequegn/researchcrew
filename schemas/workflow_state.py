...
class Source(BaseModel):
    ...
    credibility: ConfidenceLevel | None = Field(default=None, description="Source credibility")
...
class WorkflowState(BaseModel):
    ...
    session_context: str | None = Field(default=None, description="Context from previous turns in this session")

    # Phase outputs (populated as workflow progresses)
    research: ResearchState | None = Field(default=None)
    synthesis: SynthesisState | None = Field(default=None)
    fact_check: FactCheckState | None = Field(default=None)
    report: ReportState | None = Field(default=None)
